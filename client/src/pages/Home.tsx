        ...
        <div className="container mx-auto px-4">
          <nav className="flex items-center justify-between h-20">
            <a href="/" onClick={() => scrollToSection("anasayfa")} className="flex items-center gap-3 cursor-pointer">
              <img src="/araz-vinc-logo.webp" alt="Araz Vinç Salihli" className="h-14 md:h-16 w-auto object-contain" width="160" height="80" />
            </a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                <img src="/araz-vinc-logo.webp" alt="Araz Vinç Salihli" loading="lazy" decoding="async" className="h-16 w-auto object-contain" width="140" height="70" />
              </div>
