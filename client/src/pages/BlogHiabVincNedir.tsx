      ...
      <article className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Araz Vinç olarak Salihli, Manisa, <Link href="/ahmetli-vinc-kiralama" className="text-orange-600 font-semibold hover:underline">Ahmetli vinç kiralama</Link>, <Link href="/alasehir-vinc-kiralama" className="text-orange-600 font-semibold hover:underline">Alaşehir</Link>, <Link href="/kula-vinc-kiralama" className="text-orange-600 font-semibold hover:underline">Kula vinç kiralama</Link> ve Demirci bölgelerinde 55 ton kapasiteli Hiab vincimizle hizmet veriyoruz. İhtiyacınıza göre <Link href="/mobil-vinc-kiralama-salihli" className="text-orange-600 font-semibold hover:underline">Salihli mobil vinç kiralama</Link> ve <Link href="/sanayi-vinc-kiralama-salihli" className="text-orange-600 font-semibold hover:underline">sanayi tesisleri vinç kiralama</Link> hizmetlerimizden de faydalanabilirsiniz. Deneyimli operatörlerimiz ve sigortalı ekipmanımızla 7/24 yanınızdayız.
            </p>
          </div>
        </div>
      </article>
