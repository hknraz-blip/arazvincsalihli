          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="space-y-6 mb-10">
              {[
                {
                  no: "1",
                  title: "Yükü Kaldırmadan Önce Ağırlığını Öğrenin",
                  desc: "Taşınacak yükün ağırlığı bilinmeden operasyon başlatılmamalıdır. Vincin kapasitesinin üzerinde yük kaldırmaya çalışmak hem ekipmanı hem de operatörü tehlikeye atar. Yük belgesi veya teknik şartname mutlaka kontrol edilmelidir.",
                },
                {
                  no: "2",
                  title: "Zemin Sağlamlığını Kontrol Edin",
                  desc: "Vinç kurulmadan önce zeminin sağlam ve düz olduğundan emin olunmalıdır. Yumuşak veya eğimli zemin, vincin devrilmesine yol açabilir. Gerekirse tahta takoz veya çelik plaka kullanılmalıdır.",
                },
                {
                  no: "3",
                  title: "Sertifikalı Operatörle Çalışın",
                  desc: "Vinç operatörünün geçerli iş makinesi operatör belgesi olması zorunludur. Belgesiz operatör çalıştırmak hem yasal sorumluluk hem de güvenlik açısından büyük risk taşır.",
                },
                {
                  no: "4",
                  title: "Güvenli Mesafeyi Koruyun",
                  desc: "Yük havadayken operasyon alanına yetkisiz kişilerin girmesi kesinlikle engellenmeli, etraf barikat veya şerit ile kapatılmalıdır. Minimum 5 metre güvenli mesafe şarttır.",
                },
                {
                  no: "5",
                  title: "Bağlama Ekipmanını Doğru Kullanın",
                  desc: "Sapanlar, kancalar ve zincirler uygun kapasitede seçilmeli ve hasar görmüş olanlar kullanım dışı bırakılmalıdır. Yük dengesiz bağlanmamalıdır.",
                },
                {
                  no: "6",
                  title: "Elektrik Hatlarına Dikkat Edin",
                  desc: "Vinç kolunun veya yükün elektrik hatlarına temas etmesi hayati tehlike yaratır. Operasyon başlamadan önce çevredeki elektrik hatları tespit edilmeli, gerekirse ilgili kurumdan hat kapatma talep edilmelidir.",
                },
                {
                  no: "7",
                  title: "İletişim Kesintisiz Olmalı",
                  desc: "Operatör ile saha yönlendiricisinin (slingerci) sürekli görsel veya telsiz iletişimi olmalıdır. Kör noktalarda tek başına hareket edilmemelidir.",
                },
                {
                  no: "8",
                  title: "Hava Koşullarını Takip Edin",
                  desc: "Güçlü rüzgar (saatte 50 km üzeri), yağmur veya sis gibi olumsuz hava koşullarında operasyonlar durdurulmalıdır. Rüzgar, havada yük sallayarak kontrol kaybına yol açabilir.",
                },
                {
                  no: "9",
                  title: "Periyodik Bakımları Aksatmayın",
                  desc: "Vinç ve taşıma ekipmanlarının düzenli bakımı hem yasal zorunluluk hem de güvenlik gereksinimidir. Bakımsız ekipman beklenmedik arızalara ve kazalara davetiye çıkarır.",
                },
                {
                  no: "10",
                  title: "Kişisel Koruyucu Ekipman Kullanın",
                  desc: "Baret, güvenlik yeleği, çelik burunlu bot ve gerektiğinde eldiven kullanımı zorunludur. Saha içinde KKD olmadan çalışmak yasal olarak yasaktır.",
                },
              ].map((item) => (
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Araz Vinç olarak tüm operasyonlarımızı yukarıdaki güvenlik kurallarına uygun şekilde yürütüyoruz. Sertifikalı operatörlerimiz, sigortalı ekipmanlarımız ve 25 yılı aşkın deneyimimizle Salihli ve Manisa'da güvenli vinç hizmetleri sunuyoruz.
            </p>
          </div>
        </div>
      </article>
