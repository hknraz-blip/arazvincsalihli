...
export default function ServiceIndustrial() {
  ...
  useSEO({
    ...
    description: "Salihli OSB ve Manisa sanayi tesislerinde ağır ekipman taşıma, makine montajı ve fabrika nakliyesi. Uzman ekip, modern vinç. Tel: 0544 451 33 41",
    canonical: "https://arazvincsalihli.com/service/industrial",
  });
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="max-w-3xl text-white">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Salihli OSB ve Manisa sanayi bölgelerinde makine montajı, fabrika nakliyesi ve ağır sanayi ekipmanı kaldırma hizmetleri.
            </p>
            <a href="tel:05444513341">
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: Truck, title: "Makine Montajı", desc: "Sanayi makinelerinin kurulum noktasına hassas taşınması" },
              { icon: CheckCircle, title: "Fabrika Nakliyesi", desc: "Komple fabrika taşıma ve yeniden kurulum desteği" },
              { icon: Shield, title: "Jeneratör & Kazan", desc: "Büyük hacimli sanayi ekipmanlarının kaldırılması" },
              { icon: Truck, title: "Silo Kurulumu", desc: "Gıda ve kimya tesislerinde silo yerleştirme" },
              { icon: CheckCircle, title: "Salihli OSB", desc: "OSB içindeki firmalara özel vinç ve taşıma desteği" },
              { icon: Shield, title: "Acil Müdahale", desc: "Üretim durduran arızalarda hızlı ekipman taşıma" },
